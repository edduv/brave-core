...
class BatAdsRefillUnblindedTokensTest : public UnitTestBase {
 protected:
  BatAdsRefillUnblindedTokensTest()
      : token_generator_mock_(std::make_unique<
            NiceMock<privacy::TokenGeneratorMock>>()),
        refill_unblinded_tokens_(std::make_unique<
            RefillUnblindedTokens>(token_generator_mock_.get())),
  ...
  std::vector<Token> GetTokens() {
    const std::vector<std::string> tokens_base64 = {
      R"(DH7weiDOCuGT2nXcnlmX7G5cybawo3YevuaEM0WXqNHxzpcwbcrftQ5QA9OTjLJwvTwBQyatHa8MSIyfffH+WVfblV4CgHL4/dYqnU8qt8PoB81inyrXRhI9ms5t8CYO)",
      ...
      R"(jSWJU4IvIrFnsnITyLVvQ48rw5mUe/Q7gZsIqdM+Fo9PCdLJDjL9t3B02Ttxksg2yat2dpN6hGOafnG7t35QW0nqL+OV7w5/RUm++6PZvMHyoyU/qwrD87TIuTZAO3MD)",
      R"(zo5rovlE6KzkgdXCGzl94Dp8w+MWsGj0EXBYshbOmEioyo1ql+tlZmy/i3zZBHrlNc62xlDegK8RrMwFlggAPcrk6aXJcQtj5G8ivXFoQuDJ2LOeCgckYqMZYHivwqgC)",
      R"(0+36W3XcOqC2dLgfkfN/5XFu9/kbI4PIuHuXtqMbG1OG9EYvXaTDBainQpXnqyDZpAqaCf8dVNXsRcDx4V9TrB17KqqXSmNHIIhWozNAuVBdOnEAZHTBfe7wIVc5GRAF)",
      R"(HdN2p+JKkPhnGRw06Sf3WBoMjbaj3TjQNa9eyG+Ei/Bs3W6GXFZGdB8v3/Z1wrQzHksXQ/23VFj3WaTsAMhd/lWogDb7C+g1GghxLSj3BjOP5sU8JzowtPrPfmYr/HYE)",
      R"(0wMbnHVmi67JvR53IxCG0rBBWsXV/rpxy44iEpq1nqA4o5A8BO5AC6T8JjMFgEEvWBwNeXfSgUMSgnU44XiE/wKp6HfX2FGcqF0QCNwA1RQxHKxiWMCVvFkxHUx5vYQL)",
      R"(5iBzJ0cCF3eqgjcBwDblnDyAwk4HC+f4k068Edy55f7eQTZtx9c2AX21j983+kBIKQeqI80/q9iNrbgFbpWrzRvLurX+xLmFnrWieg11irgQsXVFFV5DNyxrAFRGU4sL)",
      R"(ZfK/2GB1Zi9zSBLwva5KVxMa2DSd0jyqgGN4r1MW8+mJ1ugYh9kjvimWhyeQTjXfmeIyV/qeDvpiUsHrlRqab4PzHmnmzg3pbE/z+TQ1NXGG8my66vB4+1/FqXSN22cL)",
      R"(CyjZY1hJsB5UlVzF5s/jpmGN/q5r1rwEfAFooL7z2kRtezIwetRISfJ1KIsDVsVwGYQKhAFF62GztJ7FXpZ1FfmPiGL5rE7wbPfE2T4CAmH9DEe2UPUIOeMhzjIgpGIH)",
      R"(faN7sGwuyZ7ag61a35wt7S5XvIQDi5LdH2NK8mp+NCqQPGQxxOZvR1UFI99oQgo5tDyoVMHRcDSKHjHI5GWdo0bLcwqKaUHQtsGvq4kUtKJATYlwGA1D3EZ0TtqWH8EG)",
      R"(k9swupRZLdMMEiWJQFAu0LoiH6TeWX4J14bX/YE1rMZ4BagnpeSjwUmZLMUHsKJiFdnSqpDtFuNKGH/K3Mh+ZBcyisLFHZkRTu9tb96Psld5aa5JMXThtJf0jxHgXTMG)",
      R"(Gw1iI5Cl1gCmXYGjrx2cdA/FbY5MCgk1Mpkr1hoCwtnX5Au5Ahaivb08GNJVLu8su09gFPm7Nx6ZozidjG/DsgHCrxBbnTjWfNoSf5qzXf4ffx+kfBiCusEPJkrbS7QD)",
      R"(kMmzIwG6K0/SG85lWcLY8LRMWjIeR4vvNix6ZaTVZWMXjQeejaaVUEld1gqvoNmaubmQtgy5UMBKs+39RTVgUPDOyjld9dvcsqy1FP/jZe9cxncRPKWKEZ6RTKT8JA8L)",
      R"(SbQ+dBXHxMuCaA0Yh+Jzsf7+egTCPNYsWDHkNs3ZNO66w48Oeal571xny6R0Ox9KC8QW/3srB1jT6/pMcWSt/ZHRCDel6pxyfqZ+x6OVVZsMNH6IrXWyzT/YGUjnALAK)",
      R"(oOTFr0aRkJdht7CuLbOEKu59R6lGmb6rCaOX5MUrJ5dd1lVU7Z+mfte1IKufyeab+P2ksEugtR3LCUJL8TFhrXXfDQoOf7dUdqJpyvOWqYLu1uckjpPOmLpPk0aSVqgF)",
      R"(EupatYmtXTYLbrQjP0pQGhSSNOXflaw95wnhITVOii5dNnQHIdq12iVwQNQSTy5jschTcRFBcPH6/+A+CKy4gsadXsYn2mWjDIq+goK1C1DkUSCAomtQINQsnX8y0l0L)",
      R"(w1owKX96yhN8UfiW4BFr9C1d4q8IKVBLpl8VJUt2pqH58am/lr+VhYMvQnuzMM69dcnV2XRjNttQHhTV+xrSPENkzrCN1HBmCtcu9tKQsIsA1BTR5m8IYp5PqgR6Ij8M)",
      R"(+MWbSoJkz+KCnz9b3CQeeiaXjedx5p5gjbEYHh8/38OUETq6PiuONnpz6D9n5UfE8hCONwXu18t12LQwehZ2JZF+JA3MCH8FpetZN4WoGz/xU2LQkTdgeSIPu/lSrYcM)",
      R"(Lg88mfaH3gnlJhYMjD4x8XfSmHtcVlpVivjdzx2z1kml3vHHWCyBH5OpZ9qYO3bYxzJ7gDJa4296vuj/diivDIzEpiJxJ0lzutW24Fh2zLqR3LxrIYGyZlSx1nE/luAB)",
      R"(y1YL2GOWObDr3LorCpFJAtmyUPMdfuoECFQ9a+kxlBEraPZCaaATkYXkuSUd/jodAM5OdQeAgFIF2srj3oyoIu76Y0B3uFYksu+pRB2tWYbbpONjBgNHTc3GzBZsYT8E)",
      R"(jBhIEjo/MVOOE34Ab3xhoPlXvb3rIzlLOGJ/DEcVDAxfvSrNPrp1ILWpz93xfnMAFwG7b+LI5OmnmEHCQ0abUxDqEg5pG/e5xBbyWrXoOVkQ3xfYdnlafc4FxzSW4L8C)",
      R"(plRDwdeaW7SbRefcX+geKMoCcym7H5UHRY5o7YZB9yjmlZbi2/H8Y1YqPoLfpK3fxAgikzhtg8IovdVpNu+SYuk9powxeYiNvSm+/ZB9ywU0r0IZKB4kYmuvusECrH8A)",
      ...
      R"(aRz6158ReeSiTbBj9nW1t3e50drDQeQP6xSuSHo8kodIt1tOIPRNVGdjns4eU61qlIaNwJZp5VG0n+2DwhCQsgpxyZbx3+nXL/Uczyp8YwJCWtnBqhhKvvazGdJW1OgE)",
      R"(oBD52LQLAE1bo5s6NGPt0rGeQMGROHrN679EWza161Hyhz+UN1BRZV9stHkxSPbvHyF2oqwB1vkDRSG9p/3ZFfNanYubT0f50VTrBG4Q8tHzglTMlNHKujeSaalvfF4A)",
      R"(VaQF+uAP7LTke6BDhVsgjVEX0PmG7fs0v7RbRI4KMXwqRsMNUtJXFNnyoGxiN4jQGzXyYVqUKVJsa+tabC8tQpPwGtpUMMhmBpb/+j1LH3Lwap+zVW93qrq/A72Ep60C)",
      R"(N4Z0LLuPUMVqpTzKXZfPuzbSreG38+zKIgSTMxJMsEyXcu6t40IL6T2N6mQKILW6qptih/oZd35zTDa0OYFJpNbogUazlSdYoi2PPxcASPyszv3K6v+ngeydVmXFSS8L)",
      R"(FlYLp/mxj9Z2mUJJpjVFS6mRrU65guREXj5gKDDWZe6cMHOExqr6Empym+mGke3Z0MuqN1n9ks17Zo/tgqwZgDYZhM8iHvcUTnhvQORGpigfeU6TETwyvptgWVqYQLwK)",
      R"(bi8JH/URcjgb6J6+KVYK8u15AgiqZm7MJ7bxMjDPF77ddCOT34c8j8b53Dd43CKHabHKOF01ch0zBUNFNqNWTT9CeuRZhLrJl/TpsSHm8bq4grBCCgkXUOqFrQsqaqYI)",
      R"(9byplT3SZycXf8bjX3Wx6wrByx2Kg4zGMMjOHZlii8iFJohxAh4Msb/gq/9jkbbBvV/9SVDP+cZeJ4g3FIR7atHEZIE064jTa411pQPG0QXgAgB+OrTDEFmm+Zt8Wj8I)",
      R"(ZtrPsqGR4y/yGooOJQbfFe5kQOIBXS9fGi94vojCEsHaDAkJ2vZJLaSJ5nU+ZkDUQ7doFrtd6/5y6Tsjq1MNqqNBtc0zab4QB+n96ow7a/mco7pf7TnD4G/hVakYOO0L)",
      R"(tUeXr0aILiTglTjI9HLgHPzrKPwkqwulcob0/OI7T/96mXUHa30lbXsmIfjppJm4UnmwtF8hBhGkIFpgboskisM2twOS8S/Bgle8IoF1DZ5ALQ/q2mRje32Gx+xL8EwO)",
      R"(0x67wnJxXBO+95sOd044KChhi4GY2c6bVFJNVZ2H69YrhMgPK+V3J6N0hO6GGwmsDlXOVIGAOYPiDfev18mQk4IgDfcNrBbOtZXRUewJ/E7YS2t2m0rlOzsvUznzfsQB)",
      R"(M5BGHqrzwywJpKjx5t7X/2hoFTio+eVaZVKGow4kwy0s8W/BAcH1pAPfPOTFl283qh6iNNRQbncb4xSQHOBGtsUWMdePuShtA7bVnD9bmkFVvkGlD+8YxkUhFcrKUGIC)",
      R"(AVjSnnK//7C1YmPHn5nr5oacX2BkhFm5W9Riv/ntQa6QqMTOe3EizakaZS9bIScP8TxJsFhUj/yAeXlMV2kG+mA7VrewXpfJ0pbS7vg3FnoL+mpAOsLSff41iGD9jwIB)",
      R"(UglijJk6Fj9dTxC6TR2Vw8jrTKkBwenXWAHZXkOI5OVMrDQID6qbM6qe50hLNl3sRhmhAQrUGkcMuakI5xh3cCctvCoqKC04JtEAUknlfwRbv3yHIfNgsiVxtyRoDNUA)",
      ...
      R"(4KMeGsXiusi5VpVJJ81Uxc9goJ9jFlArRiFwYxr9DT4YXuNwYvwLqrHjrQM+2jv6cm78CsFYWxJKpepGK2oF45EOyvsX9SvXLRQa6gZYRNeP9PwCH7mHztgFvPbHnpgL)",
      R"(LiRyEYTu6ppsahSjFfz/2owWySGVSqojs9nxEDS7BUtBcjEMzGJB7p+pzC6ljfZm0BRTJz1sL9B8h0GM5LPE/Qs5OP6uyiks03QK2wfyf7Gw5njhpVz0/HdE2IYbFlsE)",
      R"(M0o812DGEcbp6B7rmqFQV/xWMkLb8CGDP3iEv8CNtp8VPTS0GoMgybQlgEEwFbCY6IvT8GqZJtiYEELU3NxEGfkGsD3SVeeGPRJhRr6RpV/cEkpMrjsl5tYj3cSqHJQK)",
      R"(iwQDnYJHOA1BbtHEiwVUxV1LVchhngtjEf2vT0aYIETqPv2wXr7M70+ZKSzifXJrBbmPok4uXXZCU1WWxNH0JSg6XXRRv/J5LrM+zhjMCkeM4ndo7QbXweZXM1ynpLMH)",
      R"(eSv9KL7NaBFVvvFTm2WrmBZTmE5+znYRPFwqtWEdd6q9OLHLgPsbtf7ROQ0D/L0KmfH/rwfuPKki+IQQs5/+CVstxa8bIf+s9ZXrguyfjK/6YqPZ1B8PU/UPAwfRk68N)",
      R"(0SnR2MlzedPjCtTunhDiXM1wBp+dJPxsZU7JKwlsHwLIFSMJmBKeSQPBOajBIisqK9aS3gS0xt9+tPYacGdwcfECLVUPdhRby9SAuWZBRUIF89XMxSa73IsQNaWUeqQA)",
      R"(ClKVqKc+Iv/AGczdmZ8E520mPUfNc2cE7P1+Jm9NxwJZZDuCzn3/wvhBHpJvSj1iNsCyYjjIhSqxGaT24Ita2c330zl2PBIaA4eoBmmW4HUYtNcpXdo6qE6RadspKAYB)",
      R"(itu0lbk4kgn0cQP0iiksduQZjKRcDPfnTh2B/Lnqir+4eZKsJmD/oYoLwwT6riiEuFY6FappNzcugHd/M1mw7+fkACivxSBuNPRfLYzWn7L0Z98CKMZHMa35lt1IdaUM)",
      R"(iJ4njAR7URIjWK+/TU9hjA5WxySN/vFDR1sC2FAYM7vt1aue58eF+KZS1qSlfcy2anEATeKCCfn0J0e+buSMrO9jxVUYqCuoF9vxwZQRwVsk3dInXS48bHKgQBdUXJwA)",
      R"(jNUU4EjWeWhY6NW63ayLmPqguWcyxKZGFX9Ynj2JaMths/m+slg8js3N+dOu124QnU6Re4+fitqyL+4cFVKhrO0F6+7iEk6Ip2DbCdXDTzaX+m655Xume8CZ3jBJlYkE)",
      R"(SgYf6rrnry9EIWiJWNAcgp+6TsucKXXO4vPEkC0NioJYLp6QOCThiwSRnkkFHqMzVt4YIooowXaaXwrfGjXvZiL98rt1eddhYRgJJx+ZP7T0L0Kp2o7ezIOJsCCz1HIF)",
      R"(B77P8PpGowklUcjCGw6l/31IRdXgp2gjzuQye11kW0jG3/jktIRME4ipIsgrZ2IMyEaGvGk+0xL4zeir0Fs143+lSmqEgIPnTQoaygfobmSB235W/0fI/uhOsW8NfN0D)"
    };
...
TEST_F(BatAdsRefillUnblindedTokensTest,
  ...
  EXPECT_CALL(*refill_unblinded_tokens_delegate_mock_,
      OnWillRetryRefillingUnblindedTokens()).Times(0);
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    CatalogIssuersPublicKeyMismatch) {
  // Arrange
  const URLEndpoints endpoints = GetValidUrlRequestEndPoints();
  MockUrlRequest(ads_client_mock_, endpoints);
  ...
  // Act
  EXPECT_CALL(*refill_unblinded_tokens_delegate_mock_,
      OnDidRefillUnblindedTokens()).Times(0);
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    RequestSignedTokensInternalServerError) {
  // Arrange
  ...
  EXPECT_CALL(*refill_unblinded_tokens_delegate_mock_,
      OnFailedToRefillUnblindedTokens()).Times(2);

  EXPECT_CALL(*refill_unblinded_tokens_delegate_mock_,
      OnWillRetryRefillingUnblindedTokens()).Times(2);
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    RequestSignedTokensMissingNonce) {
  // Arrange
  const URLEndpoints endpoints = {
    {
      R"(/v1/confirmation/token/27a39b2f-9b2e-4eb0-bbb2-2f84447496e7)", {
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    GetSignedTokensInternalServerError) {
  // Arrange
  const URLEndpoints endpoints = {
    {
      // Request signed tokens
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    GetSignedTokensInvalidResponse) {
  // Arrange
  const URLEndpoints endpoints = {
    {
      // Request signed tokens
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    GetSignedTokensMissingPublicKey) {
  // Arrange
  const URLEndpoints endpoints = {
    {
      // Request signed tokens
...
TEST_F(BatAdsRefillUnblindedTokensTest,
  ...
  Token invalid_token = Token::decode_base64("foobar");
...
TEST_F(BatAdsRefillUnblindedTokensTest,
    RefillIfBelowTheMinimumThreshold) {
  // Arrange
  privacy::UnblindedTokenList unblinded_tokens =
