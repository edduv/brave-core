...
def HasDiff():
    return bool(git_cl.RunCommand(['git', 'diff']))
...
def main(args):
  ...
  if HasDiff():
      print('git diff is non-empty; please stage or commit changes before running npm format.')
      return 1
  ...
  try:
      ...
      if HasDiff():
          print('Fixed formatting errors; please commit and rebase.')
          return 1
  except:
    e = sys.exc_info()[1]
